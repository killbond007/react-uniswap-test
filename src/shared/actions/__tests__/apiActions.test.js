...
describe('apiActions', () => {
	describe('request', () => {
		...
		it('returns payload', () => {
			...
			const { payload } = request(requestUrl, requestOptions, transactionId, successMessage)
			expect(payload).toEqual({ requestUrl, requestOptions, transactionId, successMessage })
		})
	})
